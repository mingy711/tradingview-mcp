...
| `alert_create` / `alert_create_for_watchlist` / `alert_list` / `alert_delete` | Manage price alerts (single symbol or whole watchlist) |
...
- **Transport**: MCP over stdio (81 tools) + CLI (`tv` command, 30 commands with 70 subcommands)
